...
"}"
"};"
"xhttp.open(\"POST\", \"/fingers\", true);"
"xhttp.setRequestHeader(\"Content-type\", \"application/x-www-form-urlencoded\");"
"let params = \"\";"
"for (let i = 1; i < 6; ++i){"
"params += \"finger\"+i+\"=\"+document.getElementById(\"finger\"+i).value;"
"if (i < 5){"
"params += \"&\";"
"}"
"}"
...
"<body bgcolor=white>"
"<h1>RoboHand</h1>"
"<form action=\"fingers\" method=\"POST\" onchange=\"mySubmit()\">"
"<input type=\"range\" min=\"0.0\" max=\"1.0\" step=\"0.05\" name=\"finger1\" id=\"finger1\">"
"<input type=\"range\" min=\"0.0\" max=\"1.0\" step=\"0.05\" name=\"finger2\" id=\"finger2\">"
"<input type=\"range\" min=\"0.0\" max=\"1.0\" step=\"0.05\" name=\"finger3\" id=\"finger3\">"
"<input type=\"range\" min=\"0.0\" max=\"1.0\" step=\"0.05\" name=\"finger4\" id=\"finger4\">"
"<input type=\"range\" min=\"0.0\" max=\"1.0\" step=\"0.05\" name=\"finger5\" id=\"finger5\">"
